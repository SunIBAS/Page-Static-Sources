...
let key = fs.readFileSync('./key.txt', 'utf-8');
...
fs.writeFileSync('./enLeft.json', JSON.stringify(enLeft), 'utf-8');
...
fs.writeFileSync('./en.all.content.json', JSON.stringify(enLeft), 'utf-8');