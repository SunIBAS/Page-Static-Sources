let DrawImage = class {
    ...
    _redraw(imageUrl) {
        ...
        // let currentWidth = Math.abs(p1.x - p2.x);
        // let currentHeight = Math.abs(p1.y - p2.y);
        // let sourceWidth = this.image.width;
        // let sourceHeight = this.image.height;
        // let rateHeight = sourceHeight / currentHeight;
        // let rateWidth = sourceWidth / currentWidth;
        // if (rateHeight > rateWidth) {
        //     currentWidth = currentWidth / rateHeight
        // } else {
        //     currentHeight = currentHeight / rateWidth;
        // }
